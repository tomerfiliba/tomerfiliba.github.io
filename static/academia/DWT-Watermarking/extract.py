...
parser.add_option("-r", dest="sparsity", type=float, default = 0.7,
    help="PR sequence sparsity (default is 0.7)")
...
if __name__ == "__main__":
    ...
    w = Watermarker(options.payload_length, options.ecc_length, seed = options.seed, 
        mother = options.mother, sparsity = options.sparsity)
    src = misc.imread(args[0])
